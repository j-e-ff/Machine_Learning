...
# FILENAME: cnn.py
# SPECIFICATION: Build and train a Convolutional Neural Network (CNN) using 
#                TensorFlow and Keras to classify 32x32 images of handwritten
#                digits (0-9). Load the dataset using the provided helper function
#                normalize and reshape the input data for the CNN, construct a CNN
#                architecture following the guidelines in the code, train the model
#                on the training set and validate on the test set, evaluate the 
#                final model and print the test accuracy
